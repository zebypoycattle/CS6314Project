...
<body>
  ...
  if($accountType == 'student') {
    ...
    echo "<table class='table table-striped'><tr><td>Department</td><td>Course Number</td><td>Section</td><td>Course Name</td><td>Semester</td><td>Year</td><td>Schedule<td>Location</td><td>Level</td></tr>";
  
    while($row = mysqli_fetch_array($result)) {
      echo "<tr><td>".$row["DName"]."</td><td>".$row["CNumber"]."</td><td>" .$row["Section"]. "</td><td>". $row["CName"]."</td><td>".$row["Semester"]."</td><td>".$row["Year"]."</td><td>".$row["Day"]." ".$row["Time"]."</td><td>".$row["Location"]."</td><td>".$row["Level"]."</td></tr>";
    }
  }
  else {
    $sql = "SELECT c.*, d.DName 
