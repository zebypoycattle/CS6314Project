...
{
  echo "<table class='table table-striped'><tr><td>Class Section</td><td>Class Name</td><td>Professor</td><td>Time</td><td>Location</td><td>Textbook</td><td>Fill</td><td>Add To Cart</td><td>Remove From Favorites</td></tr>";
}
