...
<script type="text/javascript">
  ...
  function showData ()
  {
    ...
    xmlhttp.onreadystatechange = function()
    {
        ...
        {
            document.getElementById("favorites_results").innerHTML = this.responseText;
        }
    };
    ...
    var http = "favorites_search.php?name=" + name +"&section="+section+"&level="+level+"&location="+location;
  ...
  function remove_from_favorites(CID)
  {
